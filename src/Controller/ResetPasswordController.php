...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, SerializerInterface $serializer, MailerInterface $mailer, TranslatorInterface $translator, UserRepository $repository): Response
    {
     ...
     */
    #[Route('/check-email', name: 'api_check_email')]
    public function checkEmail(): JsonResponse
    {
        ...
        return $this->json($resetToken, 200);
    ...
    public function reset(Request $request, UserRepository $repository, SerializerInterface $serializer, UserPasswordHasherInterface $hasher, TranslatorInterface $translator, string $token = null): Response
    {
        ...
        if ($newPassword->password() === $newPassword->getConfirmPassword()) {
            ...
            throw new Exception("The filled out password does not correspond to the confirm password.");
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, UserRepository $repository, TranslatorInterface $translator): RedirectResponse
    // JsonResponse
    {
