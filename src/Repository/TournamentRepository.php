...
class TournamentRepository extends ServiceEntityRepository
{
    ...
    public function findAllSeasonalTournaments(): array
    {
        $today = new \DateTime();
        if (in_array($today->format("m"), ["09", "10", "11", "12"])) {
            $currentSeason = "20" . $today->format("y") . "/20" . $today->format("y") + 1;
        } else {
            $currentSeason = "20" . $today->format("y") - 1 . "/20"  . $today->format("y");
        }
